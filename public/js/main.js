...
var defaultCurrency = localStorage.getItem('insight-currency') || 'BYD';
  ...
  function($scope, $rootScope, Currency) {
    ...
    $rootScope.currency.getConvertion = function(value) {
      ...
      if (!isNaN(value) && typeof value !== 'undefined' && value !== null) {
        ...
        } else if (this.symbol === 'mBYD') {
          this.factor = 1000;
          response = _roundFloat((value * this.factor), 5);
        } else if (this.symbol === 'bits') {
          this.factor = 1000000;
          response = _roundFloat((value * this.factor), 2);
        } else { // assumes symbol is BYD
          this.factor = 1;
...
angular.module('insight.search').controller('SearchController',
  function($scope, $routeParams, $location, $timeout, Global, Block, Transaction, Address, BlockByHeight, Trace) {
  $scope.global = Global;
  $scope.loading = false;
...
// Source: public/src/js/controllers/trace.js
...
// Source: public/src/js/services/trace.js
angular.module ('insight.trace')
